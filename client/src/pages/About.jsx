function About(){
    return(
        <div className='flex items-center justify-center min-h-screen'>
          <div className='bg-slate-300 p-8 rounded-md shadow-md max-w-2xl'>
